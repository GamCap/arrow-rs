...
//! Contains reader which reads parquet data into arrow-gamcap array.
...
/// Arrow reader api.
/// With this api, user can get arrow-gamcap schema from parquet file, and read parquet data
/// into arrow-gamcap arrays.
pub trait ArrowReader {
    type RecordReader: RecordBatchReader;

    /// Read parquet schema and convert it into arrow-gamcap schema.
