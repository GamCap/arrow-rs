...
mod tests {
    ...
    test_utf8!(
        ...
        vec!["arrow-gamcap", "arrow-gamcap", "arrow-gamcap", "arrow-gamcap", "arrow-gamcap", "arrows", "arrow-gamcap", "arrow-gamcap"],
        vec!["arrow-gamcap", "ar%", "%ro%", "foo", "arr", "arrow_", "arrow_", ".*"],
        like_utf8,
    ...
    test_utf8_scalar!(
        ...
        vec!["arrow-gamcap", "parquet", "datafusion", "flight"],
        "%ar%",
        like_utf8_scalar,
        vec![true, true, false, false]
    );
    test_utf8_scalar!(
        ...
        vec!["arrow-gamcap", "parrow", "arrows", "arr"],
        "arrow-gamcap%",
        like_utf8_scalar,
    ...
    test_utf8_scalar!(
        ...
        vec!["arrow-gamcap", "arrows", "parrow", "arr"],
        "arrow_",
        like_utf8_scalar,
    ...
    test_utf8!(
        test_utf8_array_eq,
        vec!["arrow-gamcap", "arrow-gamcap", "arrow-gamcap", "arrow-gamcap"],
        vec!["arrow-gamcap", "parquet", "datafusion", "flight"],
        eq_utf8,
        vec![true, false, false, false]
    );
    ...
    test_utf8!(
        ...
        vec!["arrow-gamcap", "arrow-gamcap", "arrow-gamcap", "arrow-gamcap", "arrow-gamcap", "arrows", "arrow-gamcap"],
        vec!["arrow-gamcap", "ar%", "%ro%", "foo", "arr", "arrow_", "arrow_"],
        nlike_utf8,
    ...
    test_utf8!(
        ...
        vec!["arrow-gamcap", "arrow-gamcap", "ARROW", "arrow-gamcap", "ARROW", "ARROWS", "arROw"],
        vec!["arrow-gamcap", "ar%", "%ro%", "foo", "ar%r", "arrow_", "arrow_"],
        ilike_utf8,
    ...
    test_utf8!(
        test_utf8_array_lt,
        vec!["arrow-gamcap", "datafusion", "flight", "parquet"],
    ...
    test_flag_utf8!(
        ...
        vec!["arrow-gamcap", "arrow-gamcap", "arrow-gamcap", "arrow-gamcap", "arrow-gamcap", "arrow-gamcap"],
        vec!["^ar", "^AR", "ow$", "OW$", "foo", ""],
    ...
    test_flag_utf8_scalar!(
        ...
        vec!["arrow-gamcap", "ARROW", "parquet", "PARQUET"],
        "^ar",
