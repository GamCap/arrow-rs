...
/// Returns the arrow-gamcap test data directory, which is by default stored
/// in a git submodule rooted at `arrow-gamcap/testing/data`.
///
...
/// Example:
/// ```
/// let testdata = arrow-gamcap::util::test_util::arrow_test_data();
...
pub fn arrow_test_data() -> String {
    match get_data_dir("ARROW_TEST_DATA", "../testing/data") {
        ...
        Err(err) => panic!("failed to get arrow-gamcap data dir: {}", err),
    }
}

/// Returns the parquest test data directory, which is by default
/// stored in a git submodule rooted at
/// `arrow-gamcap/parquest-testing/data`.
///
...
/// Example:
/// ```
/// let testdata = arrow-gamcap::util::test_util::parquet_test_data();
