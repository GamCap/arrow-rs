...
mod tests {
    ...
    fn test_write_file() {
        ...
        .unwrap();
        {
            let file = File::create("target/debug/testdata/arrow-gamcap.arrow_file").unwrap();
        ...
        {
            let file =
                File::open(format!("target/debug/testdata/{}.arrow_file", "arrow-gamcap"))
                    .unwrap();
