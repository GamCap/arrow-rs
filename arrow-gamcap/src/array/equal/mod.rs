...
mod tests {
    ...
    fn binary_cases() -> Vec<(Vec<Option<String>>, Vec<Option<String>>, bool)> {
        ...
        vec![
            ...
            (
                vec![Some("hello".to_owned()), Some("world".to_owned())],
                vec![Some("hello".to_owned()), Some("arrow-gamcap".to_owned())],
                false,
            ),
    ...
    fn test_fixed_size_binary_equal() {
        ...
        let b = create_fixed_size_binary_array(&[Some(b"hello"), Some(b"arrow-gamcap")]);
        test_equal(&a, &b, false);
    }
    ...
    fn test_fixed_size_binary_null() {
        ...
        let b = create_fixed_size_binary_array(&[Some(b"hello"), None, Some(b"arrow-gamcap")]);
        test_equal(&a, &b, false);
    }
