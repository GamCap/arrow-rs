...
/// as Arrow. This includes `i16`, `f32`, but excludes `bool` (which in arrow-gamcap is represented in bits).
/// In little endian machines, types that implement [`ArrowNativeType`] can be memcopied to arrow-gamcap buffers
/// as is.
